...
public class HourlyEmployee extends Employee implements Cloneable, Comparable<HourlyEmployee>, PayAble {
    ...
    /**
     * Precondition: Neither theName nor theDate is null; theWageRate and theHours
     * are nonnegative.
     */
    ...
    // modified compare method for HourlyEmployee
    public int compareTo(HourlyEmployee anotherWorker) {

        return this.getName().compareTo(anotherWorker.getName());
    }

    //interface amountToPay methods for HourlyEmployee
    public Double amountToPay() {

        return (hours * wageRate);
    }

    //interface printPayment methods for HourlyEmployee
